...
def external_libs_exists():
    ...
    if len(missing_libs) > 0:
        m_text = f'Brak zainstalowanych zewnętrznych bibliotek: {missing_libs}. Są one niezbędne do działania wtyczki WellMatch. Czy chcesz je teraz zainstalować?'
...
def detect_missing_libs():
    ...
    missing_libs = []
    ext_libs = ['pyarrow', 'numba', 'pandas', 'numpy', 'joblib', 'rapidfuzz', 'chardet', 'sklearn']
